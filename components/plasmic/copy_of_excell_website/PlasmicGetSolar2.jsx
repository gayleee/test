...
import sty from "./PlasmicGetSolar2.module.css"; // plasmic-import: 8h20kgQsFUq-/css
...
export const PlasmicGetSolar2__VariantProps = new Array();

export const PlasmicGetSolar2__ArgProps = new Array();
...
function PlasmicGetSolar2__RenderFunc(props) {
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div className={classNames(projectcss.all, sty.column__qfcUg)}>
                  <div
                    className={classNames(projectcss.all, sty.freeBox___0SdBw)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__rEgWt)}
                      displayHeight={
            ...
            <NavigationBar
              ...
              brand={
                ...
                >
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__iIshb)}
                    displayHeight={"40px"}
                    displayMaxHeight={"none"}
              ...
              closeButton={
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__s8RKa)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
              ...
              menuItems={
                <React.Fragment>
                  ...
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__we5Zh)}
                      displayHeight={"64px"}
                      displayMaxHeight={"none"}
                      displayMaxWidth={"298px"}
                      displayMinHeight={"0"}
              ...
              openButton={
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__kqakn)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"none"}
                  displayMinHeight={"0"}
              ...
              const child$Props = {
                ...
                extendedOnValuesChange: async (...eventArgs) => {
                  ...
                  (async (changedValues, allValues) => {
                    const $steps = {};
                    $steps["updateInput7Value"] = true
                      ? (() => {
                          const actionArgs = {
                            variable: {
                              objRoot: $state,
                              variablePath: ["input7", "value"]
                            },
                            operation: 0
                          };
                          return (({
                      ...
                      : undefined;
                    if (
                      $steps["updateInput7Value"] != null &&
                      typeof $steps["updateInput7Value"] === "object" &&
                      typeof $steps["updateInput7Value"].then === "function"
                    ) {
                      $steps["updateInput7Value"] = await $steps[
                        "updateInput7Value"
                      ];
                    }
                  }).apply(null, eventArgs);
              ...
              return (
                ...
                >
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__pbjxu)}
                  >
                    <FormItemWrapper
                      className={classNames(
                        "__wab_instance",
                        sty.formField__upd33
                      )}
                      label={
                        <div
                          className={classNames(
                  ...
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__ddQ9P)}
                  >
                    <FormItemWrapper
                      className={classNames(
                        "__wab_instance",
                        sty.formField__pXIeZ
                      )}
                      label={
                        <div
                          className={classNames(
                  ...
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__pxQwx)}
                  >
                    <DataFetcher
                  ...
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox___650Q4)}
                  >
                    <FormItemWrapper
                      className={classNames(
                        "__wab_instance",
                        sty.formField__ycckn
                      )}
                      label={
                        <div
                          className={classNames(
                  ...
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__tNZn)}
                  >
                    <FormItemWrapper
                      className={classNames(
                        "__wab_instance",
                        sty.formField__oGfTl
                      )}
                      initialValue={"\u20b10.00"}
                      label={
                        <div
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__vsttK)}>
              <div
              ...
              >
                ...
                >
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__m0GcL)}
                    displayHeight={"auto"}
                    displayMaxHeight={"none"}
                    displayMaxWidth={
                      hasVariant(globalVariants, "screen", "mobileOnly")
                  ...
                  >
                    <div
                      className={classNames(projectcss.all, sty.column__lrt2E)}
                    >
                      <Stack__
                        as={"div"}
                        hasGap={true}
                    ...
                    <div
                      className={classNames(projectcss.all, sty.column___7UzQc)}
                    >
                      <div
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicGetSolar2__ArgProps,
          internalVariantPropNames: PlasmicGetSolar2__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicGetSolar2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "getSolarPage") {
    func.displayName = "PlasmicGetSolar2";
  } else {
    func.displayName = `PlasmicGetSolar2.${nodeName}`;
  }
  return func;
}
...
export const PlasmicGetSolar2 = Object.assign(
  // Top-level PlasmicGetSolar2 renders the root element
  withUsePlasmicAuth(makeNodeComponent("getSolarPage")),
  {
    ...
    // Metadata about props expected for PlasmicGetSolar2
    internalVariantProps: PlasmicGetSolar2__VariantProps,
    internalArgProps: PlasmicGetSolar2__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "",
      description: "",
...
export default PlasmicGetSolar2;
/* prettier-ignore-end */
